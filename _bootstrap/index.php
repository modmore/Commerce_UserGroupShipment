...
if (!createObject('modNamespace',array(
    'name' => 'commerce_usergroupshipment',
    'path' => $componentPath.'/core/components/commerce_usergroupshipment/',
    'assets_path' => $componentPath.'/assets/components/commerce_usergroupshipment/',
),'name', false)) {
    echo "Error creating namespace commerce_usergroupshipment.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_usergroupshipment.core_path',
    'value' => $componentPath.'/core/components/commerce_usergroupshipment/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_usergroupshipment',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_usergroupshipment.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_usergroupshipment.assets_path',
    'value' => $componentPath.'/assets/components/commerce_usergroupshipment/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_usergroupshipment',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_usergroupshipment.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_usergroupshipment/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_usergroupshipment.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_usergroupshipment',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_usergroupshipment.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_usergroupshipment.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_usergroupshipment',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_usergroupshipment.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_usergroupshipment/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_usergroupshipment/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce\\UserGroupShipment\\Modules\\', $modulePath);
